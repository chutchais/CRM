...
def main():
    ...
    try:
        ...
        #3) Now On "Full/Out order" screen.
        ...
        import io
        import glob
        file_list = glob.glob('d:\\ssr\\*.xlsx')
        ...
        for vgm_file in file_list:
            ...
            for ws in wb2:
                ...
                for index,row in enumerate(ws.iter_rows()) :
                    ...
                    if booking ==None or booking=='None':
                        continue

                    # Check Booking
                    execute = check_booking(booking)
                    r.write('%s,%s\n' % (booking,'executed' if execute else 'open' ))
